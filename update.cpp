...
void update_data(string ic)
{
    ...
    // if the user was not found, exit the program
    if (!userFound) {
        cerr << "User not found" << endl;
    }

    // prompt user to enter the new vaccine status
    string vaccineStatus;
    vaccineStatus = vaccination_status();

    // prompt user to enter the new COVID status
    string covidStatus;
	char cs;
	char CS;
	cout << "\nCOVID-19 Status" << endl;
	...
	{
	case 'A':
		covidStatus = "Confirmed Case";
		break;
	case 'B':
		covidStatus = "Suspected Case";
		break;
	case 'C':
		covidStatus = "Close Contact";
		break;
	case 'D':
		covidStatus = "Casual Contact";
		break;
	default:
		covidStatus = "Low Risk";
		break;
	}
	cout << "Your current Covid status is " << covidStatus << "\n";
    ...
    file << vaccineStatus << "," << covidStatus;
...
void updatevcc_txtfile()
{
	string vcc_stt = vaccination_status();
